...
> 代码位置：[src/model.rs](file:///d:/Code/Rust/llm_from_scratch/src/model.rs)（正弦位置编码 `sinusoidal_positions`、`TransformerBlock` 里的残差连接）
> 代码位置：[src/layers.rs](file:///d:/Code/Rust/llm_from_scratch/src/layers.rs)（`LayerNorm`）
