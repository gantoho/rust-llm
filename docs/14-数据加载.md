...
> 代码位置：[src/data.rs](file:///d:/Code/Rust/llm_from_scratch/src/data.rs)
> 训练入口：[src/train.rs](file:///d:/Code/Rust/llm_from_scratch/src/train.rs)（第 13 课）
...
本项目的语料是内置在 [src/data.rs](file:///d:/Code/Rust/llm_from_scratch/src/data.rs) 里的一个英文小故事：
...
`DataLoader::sample_batch` 的核心逻辑（[src/data.rs](file:///d:/Code/Rust/llm_from_scratch/src/data.rs)）：
